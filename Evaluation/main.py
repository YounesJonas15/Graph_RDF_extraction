...
triplet_ref_manuel = [
    ('University of Versailles Saint-Quentin-en-Yvelines', 'is', 'French public university'),
    ('University of Versailles Saint-Quentin-en-Yvelines', 'date of creation', '1991'),
    ('University of Versailles Saint-Quentin-en-Yvelines', 'localisation', 'department of Yvelines'),
    ('University of Versailles Saint-Quentin-en-Yvelines', 'localisation since 2002', 'Hauts-de-Seine'),
    ('University of Versailles Saint-Quentin-en-Yvelines', 'constituent', 'Paris-Saclay University.'),
    ('University of Versailles Saint-Quentin-en-Yvelines', 'Consiste', 'eight separate campuses'),
    ('University of Versailles Saint-Quentin-en-Yvelines', 'localisation', 'Versailles'),
    ('University of Versailles Saint-Quentin-en-Yvelines', 'localisation', 'Saint-Quentin-en-Yvelines'),
    ('University of Versailles Saint-Quentin-en-Yvelines', 'localisation', 'Mantes-en-Yvelines'),
    ('University of Versailles Saint-Quentin-en-Yvelines', 'localisation', 'Vélizy-Villacoublay'),
    ('University of Versailles Saint-Quentin-en-Yvelines', 'localisation', 'Rambouillet'),
    ('University of Versailles Saint-Quentin-en-Yvelines', 'part of', 'Academy of Versailles'),
    ('University of Versailles Saint-Quentin-en-Yvelines', 'part of', 'universités nouvelles'),
    ('University of Versailles Saint-Quentin-en-Yvelines', 'part of', 'new universities'),
    ...
    ('University of Versailles Saint-Quentin-en-Yvelines', 'population', '19,000 students'),
    ...
    ('University of Versailles Saint-Quentin-en-Yvelines', 'field', 'political science'),
    ...
    ('University of Versailles Saint-Quentin-en-Yvelines', 'interdisciplinary courses', 'economics'),
    ('University of Versailles Saint-Quentin-en-Yvelines', 'interdisciplinary courses', 'ethics'),
    ('University of Versailles Saint-Quentin-en-Yvelines', 'interdisciplinary courses', 'natural environment'),
    ('University of Versailles Saint-Quentin-en-Yvelines', 'interdisciplinary courses', 'sustainable development'),
